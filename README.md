...
Every World Cup needs its players — here's mine, straight from the GitHub transfer market:

<p align="center">
  <a href="https://gitfut.com/SantiagoBP95" target="_blank">
    <img src="docs/gitfut_card.png" alt="Santiago Buitrago — GitFut player card (60 BRONZE, CAM)" width="600"/>
  </a>
</p>

<p align="center"><i>Card generated by <a href="https://gitfut.com">gitfut.com</a> from real GitHub stats — click it for the live version.</i></p>
